<template>
  <div class="detailView" v-if="orderInfo">
    ...
    <div class="item">
      ...
      <div class="value">
        <el-input v-model="orderInfo.merchantName" :disabled="true" style="width: 200px"></el-input>
      </div>
    </div>
    <div class="item">
    ...
    <div class="item">
      ...
      <div class="value">
        <el-input v-model="orderInfo.merchantPhone" :disabled="true" style="width: 200px"></el-input>
      </div>
    </div>
    <div class="item">
    ...
    <div class="item">
      <div class="name">消耗劵类型：</div>
      <div class="value">
        <el-input v-model="orderInfo.couponName" :disabled="true" style="width: 200px"></el-input>
      </div>
    </div>
    <div class="item">
    ...
    <div class="item">
      <div class="name">订单评分：</div>
      <div class="value">
        <el-input v-model="orderInfo.commentGrade" :disabled="true" style="width: 200px"></el-input>
      </div>
    </div>
    <div class="item">
      <div class="name">订单状态：</div>
      <div class="value">
        <el-select v-model="orderInfo.orderState" style="width:100px">
          <el-option
...
export default {
  ...
  methods: {
    ...
    editClick: function() {
      ...
      params.orderState = orderInfo.orderState
      request({
        url: '/management/order/updateOrderDetail',
        method: 'post',
        params
      }).then(
        response => {
    ...
    queryData: function() {
      ...
      request({
        url: '/management/order/getOrderDetail',
        method: 'post',
        params
      }).then(
        response => {
