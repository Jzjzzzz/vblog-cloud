  ...
  methods: {
    ...
    remoteMethod(query) {
      if (query !== '') {
        ...
        let url = '/management/admin/searchManagementAdminList'
        request({
          url: url,
          method: 'post',
          params
    ...
    exportExcel: function() {
      ...
      let url = '/api/management/opRecord/getRecordExcel?'
    ...
    queryData(isTotal) {
      ...
      return request({
        url: '/management/opRecord/getRecordList',
        method: 'post',
        params
      })
    }
