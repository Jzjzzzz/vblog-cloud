<template>
  <div class="content">
    ...
    <el-dialog title="管理员详情" :visible.sync="showDetail" :before-close="handleClose">
      <div v-if="showDetail">
        <adminDetail :adminId="adminId" @closeClick="handleClose" />
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportExcel: function() {
      ...
      let url = '/api/management/admin/getAllManagementAdminExcel?'
    ...
    queryData(isTotal) {
      ...
      return request({
        url: '/management/admin/getAllManagementAdminList',
        method: 'post',
        params
      })
    },
